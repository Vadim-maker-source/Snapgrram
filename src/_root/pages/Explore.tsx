  ...
  return (
    <div className="explore-container">
      <div className='explore-inner_container'>
        <h2 className="h3-bold md:h2-bold w-full">Найдите публикацию</h2>
      ...
      <div className="flex-between w-full max-w-5xl mt-16 mb-7">
        <h3 className="body-bold md:h3-bold">Популярное</h3>

        <div className="flex-center gap-3 bg-dark-3 rounded-xl px-4 py-2 cursor-pointer">
          <p className="small-meduium mb:base-medium text-light-2">All</p>
      ...
      {shouldShowSearchResults ? (
          ...
          <p className="text-light-4 mt-10 text-center w-full">Нет публикаций</p>
        ) : (
